...
`[InGameTopbar...]` can resolve an empty/default country or fail outright. The
nation-summary button now passes the player country explicitly with
...
unchanged until the nation-summary route passes disposable-campaign live
acceptance. The game date remains
